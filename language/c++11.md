...
<pre>
  ...
  - auto does the same thing as [template type deduction](http://en.cppreference.com/w/cpp/language/template_argument_deduction), being by-value for references
...
#### Avoid using with uniform init

Otherwise, it's just hard to figure out what's the intention.
...
In cpp11, the lambda will capture by value of the 'const' type, while bind capture type.
