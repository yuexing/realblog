...
As far as I know, we don't encourage usage of exception in Tango codebase. Let me know if I am wrong.
...
Cpp implements lambda as non-closure, so the lifetime of the outer variables will not change because of using lambda. 

- A lambda expression can access outer variables in which it is defined
  - by reference [&v] [&]
  - by value [=v] [=]
